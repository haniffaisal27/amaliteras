...
<body>
    <center>
        <table>
            <caption>kemaskini pekerja</caption>
            <tr>
            ...
            while ($pelajar = mysqli_fetch_array($data)){
                ...
                <tr>
                    ...
                    <td>
                        <a href="add.php?nokp=<?php echo $pelajar['nokp'];?>">
                            <img src=update.png style="height: 20px; width: 20px;"> </a> 
                        <a href="delete.php?nokp=<?php echo $pelajar['nokp'];?>">
                            <img src=delete.kpg.png style="height: 20px; width: 20px;"> </a> 
                    </td> 
                </tr> 
            <?php $bil = $bil + 1; 
            } 
        ...
        <button><a href="tambah.php">Tambah nama</a></button>
